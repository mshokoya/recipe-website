...
export type RecipeWhereInput = {
  ...
  statusId?: Maybe<Scalars['String']>;
  /** All values that are not equal to given value. */
  statusId_not?: Maybe<Scalars['String']>;
  /** All values that are contained in given list. */
  statusId_in?: Maybe<Array<Scalars['String']>>;
  /** All values that are not contained in given list. */
  statusId_not_in?: Maybe<Array<Scalars['String']>>;
  /** All values containing the given string. */
  statusId_contains?: Maybe<Scalars['String']>;
  /** All values not containing the given string. */
  statusId_not_contains?: Maybe<Scalars['String']>;
  /** All values starting with the given string. */
  statusId_starts_with?: Maybe<Scalars['String']>;
  /** All values not starting with the given string. */
  statusId_not_starts_with?: Maybe<Scalars['String']>;
  /** All values ending with the given string. */
  statusId_ends_with?: Maybe<Scalars['String']>;
  /** All values not ending with the given string */
  statusId_not_ends_with?: Maybe<Scalars['String']>;
};
...
export type CreateRecipeGraphQlMutation = (
  ...
  & { createRecipe?: Maybe<(
    { __typename?: 'Recipe' }
    & Pick<Recipe, 'id' | 'statusId' | 'title' | 'content' | 'description' | 'ingredients' | 'owner'>
    & { userLikes?: Maybe<(
      { __typename?: 'UserLike' }
      & Pick<UserLike, 'id'>
    )>, images?: Maybe<(
